...
require_once APPPATH . 'libraries/class.exception.php';
/**
 * PHPMailer - PHP email creation and transport class.
 *
 * @author  Marcus Bointon (Synchro/coolbru) <phpmailer@synchromedia.co.uk>
...
// Value passed in as name:value
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
    {
        ...
        // RFC2392 S 2
                    ...
                    if (
                        $this->addEmbeddedImage($basedir . $directory . $filename, $cid, $filename, 'base64', static::_mime_types((string) static::mb_pathinfo($filename, PATHINFO_EXTENSION)))
                    ) {
